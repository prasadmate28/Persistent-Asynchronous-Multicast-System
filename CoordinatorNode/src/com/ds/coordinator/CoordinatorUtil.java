...
public class CoordinatorUtil {
	...
	public boolean register() {
		...
		try{
			...
			System.out.println("Exception in register stub "+e.getMessage());
			//e.printStackTrace();
		}
		return true;	
	}
	...
	public void deregister() {
		...
		try{
			...
			System.out.println("Exception in deregister stub:: "+e.getMessage());
			//e.printStackTrace();
		}
	}
	...
	public void reconnect() {
		...
		try{
			...
			System.out.println("Exception in reconnect stub:: " +e.getMessage());
			//e.printStackTrace();
		}
	}
	...
	public void disconnect() {
		...
		try{
			...
			System.out.println("Exception in disconnet stub "+e.getMessage());
			//e.printStackTrace();
		}
	}
	...
	public synchronized void multicastSend() {
		...
		try{
			...
			System.out.println("Exception in multicast send :: "+e.getMessage());
			//e.printStackTrace();
		}
	}
